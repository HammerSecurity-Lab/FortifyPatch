...
#define RESERVED_SIZE			UL(0x01000000)
...
// #define ARM_L1_PER_GPT_SIZE		(ARM_L1_GPT_SIZE / 2)

#define ARM_NS_DRAM1_BASE		ARM_DRAM1_BASE
#define ARM_NS_DRAM1_SIZE		(ARM_DRAM1_SIZE -		\
					 ARM_TZC_DRAM1_SIZE - RESERVED_SIZE)
...
#define ARM_MAP_RESERVED		MAP_REGION_FLAT(		\
						RESERVED_BASE,	\
						RESERVED_SIZE,	\
...
#define MAX_MMAP_REGIONS		(PLAT_ARM_MMAP_ENTRIES +	\
					 ARM_BL_REGIONS + 2)	//STOP : we add two additional region
...
#define KERNEL_INS_BASE			0x80081000
#define KERNEL_INS_END			0x80a00000			//todo(important) : need to modify
#define KERNEL_INS_VA_BASE			0xffffff8010081000
#define KERNEL_INS_VA_END			0xffffff8010a00000			//todo(important) : need to modify

#define KPROBE_SMC				0xff0f0000
#define TRAP_SMC				0xff0e0000
#define PATCH_SMC				0xff0d0000
#define PROXY_SMC				0xff0c0000
// #define PTE_PAGE_1				0x80c62000
// #define PTE_PAGE_2				0xf7ffe000
// #define PTE_PAGE_3				0xf7fff000

#define RESERVED_BASE			(ARM_PAS_2_BASE + ARM_PAS_2_SIZE)
#define RESERVED_END			(RESERVED_BASE + RESERVED_SIZE)
#define PATCH_TRIGER_NUM		0xfefffff8

/* RMM */
#define ARM_PAS_3_BASE			(ARM_AP_TZC_DRAM1_BASE)
#define ARM_PAS_3_SIZE			(ARM_AP_TZC_DRAM1_SIZE)

#define ARM_GPT_L0_BASE			(ULL(0xfea00000))
#define ARM_GPT_L1_BASE			(ULL(0xfeb00000))
#define MAX_CORE_NUM			9
...
#define	ARM_PAS_RESERVED		MAP_GPT_REGION_TBL(RESERVED_BASE, \
							   RESERVED_SIZE, \
							   GPI_ROOT)
...
#define ARM_PAS_ALL_ROOTS		MAP_GPT_REGION_TBL(ARM_PAS_2_BASE, \
							   ARM_PAS_2_SIZE + RESERVED_SIZE + ARM_PAS_3_SIZE + ARM_EL3_TZC_DRAM1_SIZE + ARM_L1_GPT_SIZE, \
							   GPI_ROOT)

#define	ARM_PAS_KERNEL_NS		MAP_GPT_REGION_TBL(ARM_PAS_2_BASE, \
							   KERNEL_INS_BASE - ARM_PAS_2_BASE, \
							   GPI_NS)

#define	ARM_PAS_KERNEL_INS		MAP_GPT_REGION_TBL(KERNEL_INS_BASE, \
							   KERNEL_INS_END - KERNEL_INS_BASE, \
							   GPI_ROOT)


#define	ARM_PAS_KERNEL_INS_SEC		MAP_GPT_REGION_TBL(KERNEL_INS_BASE, \
							   KERNEL_INS_END - KERNEL_INS_BASE, \
							   GPI_SECURE)

#define	ARM_PAS_KERNEL_NS_2		MAP_GPT_REGION_TBL(KERNEL_INS_END, \
							   ARM_PAS_2_SIZE + ARM_PAS_2_BASE - KERNEL_INS_END, \
							   GPI_NS)

#define	ARM_PAS_OTHER_ROOTS		MAP_GPT_REGION_TBL(RESERVED_BASE, \
							   RESERVED_SIZE + ARM_PAS_3_SIZE+ ARM_EL3_TZC_DRAM1_SIZE + ARM_L1_GPT_SIZE, \
							   GPI_ROOT)

#define	ARM_PAS_RMM_ROOTS		MAP_GPT_REGION_TBL(ARM_PAS_3_BASE, \
							   ARM_PAS_3_SIZE, \
							   GPI_ROOT)

#define ARM_PAS_EL3_DRAM_ROOTS		MAP_GPT_REGION_TBL(ARM_EL3_TZC_DRAM1_BASE, \
							ARM_EL3_TZC_DRAM1_SIZE, \
							GPI_ROOT)

#define	ARM_PAS_GPTS_ROOTS			MAP_GPT_REGION_TBL(ARM_L1_GPT_ADDR_BASE, \
							   ARM_L1_GPT_SIZE,      \
							   GPI_ROOT)
...
// #define ARM_L0_PER_GPT_SIZE		(ARM_L0_GPT_SIZE / 2)
/*
