...
#define _DEFINE_MY_SYSREG_WRITE_FUNC(_name, _reg_name)			\
static inline void write_ ## _name(u_register_t v)			\
{										\
	__asm__ volatile ("msr " #_reg_name ", %0" : : "r" (v));	\
}
...
/* Define write function for renamed system register */
#define DEFINE_MY_RENAME_SYSREG_WRITE_FUNC(_name, _reg_name)	\
	_DEFINE_MY_SYSREG_WRITE_FUNC(_name, _reg_name)
...
static inline void write_scr_el3(u_register_t v)
{
	// NOTICE("write scr_el3 : 0x%016lx\n", v);
	__asm__ volatile ("msr scr_el3, %0" : : "r" (v));
}
...
DEFINE_SYSREG_READ_FUNC(scr_el3)
...
DEFINE_RENAME_SYSREG_READ_FUNC(gptbr_el3, GPTBR_EL3)
DEFINE_MY_RENAME_SYSREG_WRITE_FUNC(gptbr_el3, GPTBR_EL3)
DEFINE_RENAME_SYSREG_READ_FUNC(gpccr_el3, GPCCR_EL3)
DEFINE_MY_RENAME_SYSREG_WRITE_FUNC(gpccr_el3, GPCCR_EL3)

// static inline void write_gpccr_el3(u_register_t v)
// {
// 	NOTICE("write gpccr_el3 : 0x%016lx\n", v);
// 	__asm__ volatile ("msr gpccr_el3, %0" : : "r" (v));
// }

// static inline void write_gptbr_el3(u_register_t v)
// {
// 	// NOTICE("write gptbr_el3 : 0x%016lx\n", v);
// 	__asm__ volatile ("msr gptbr_el3, %0" : : "r" (v));
// }
