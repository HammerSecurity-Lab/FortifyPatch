...
#elif !USE_ROMLIB
# define PLAT_ARM_MMAP_ENTRIES		15
...
#define PLAT_ARM_TZC_NS_DEV_ACCESS_RD	(				\
		TZC_REGION_ACCESS_RD(FVP_NSAID_DEFAULT)	|	\
		TZC_REGION_ACCESS_RD(FVP_NSAID_PCI)		|	\
		TZC_REGION_ACCESS_RD(FVP_NSAID_AP)		|	\
		TZC_REGION_ACCESS_RD(FVP_NSAID_VIRTIO)	|	\
		TZC_REGION_ACCESS_RD(FVP_NSAID_VIRTIO_OLD))
...
#define PLAT_ARM_G0_IRQ_PROPS(grp) \
	ARM_G0_IRQ_PROPS(grp), \
	INTR_PROP_DESC(FVP_IRQ_PMU_CPU0, GIC_HIGHEST_SEC_PRIORITY, (grp), \
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(FVP_IRQ_PMU_CPU1, GIC_HIGHEST_SEC_PRIORITY, (grp), \
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(FVP_IRQ_PMU_CPU2, GIC_HIGHEST_SEC_PRIORITY, (grp), \
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(FVP_IRQ_PMU_CPU3, GIC_HIGHEST_SEC_PRIORITY, (grp), \
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(FVP_IRQ_PMU_CPU4, GIC_HIGHEST_SEC_PRIORITY, (grp), \
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(FVP_IRQ_PMU_CPU5, GIC_HIGHEST_SEC_PRIORITY, (grp), \
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(FVP_IRQ_PMU_CPU6, GIC_HIGHEST_SEC_PRIORITY, (grp), \
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(FVP_IRQ_PMU_CPU7, GIC_HIGHEST_SEC_PRIORITY, (grp), \
			GIC_INTR_CFG_LEVEL)
